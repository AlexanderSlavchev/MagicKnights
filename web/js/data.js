...
(function () {
  ...
  D.COUNT_RANGES = [[1, 4, 'няколко'], [5, 9, 'малко'], [10, 19, 'глутница'], [20, 49, 'много'], [50, 99, 'орда'], [100, 249, 'множество'], [250, 499, 'рояк'], [500, 999, 'тълпа'], [1000, Infinity, 'легион']];
  ...
  D.OBJECTS = {
    ...
    shipyard: { name: 'Корабостроителница', desc: 'Строи кораб за 1000 злато и 10 дърво. Корабът се появява на съседната вода.' },
